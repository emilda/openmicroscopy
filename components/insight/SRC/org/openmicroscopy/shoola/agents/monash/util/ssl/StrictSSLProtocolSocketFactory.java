 ...
 * sure the SSL sessions server host name matches with the the host name returned in the server certificates
 * "Common Name" field of the "SubjectDN" entry.
 *
...
public class StrictSSLProtocolSocketFactory implements SecureProtocolSocketFactory {
     ...
     *
     * @param verifyHostname The host name verification flag. If set to <code>true</code> the SSL sessions server host name will be
     *                       compared to the host name returned in the server certificates "Common Name" field of the "SubjectDN"
     *                       entry. If these names do not match a Exception is thrown to indicate this. Enabling host name
     *                       verification will help to prevent from man-in-the-middle attacks. If set to <code>false</code> host
     *                       name verification is turned off.
     *                       <p/>
     *                       Code sample:
     *                       <p/>
     *                       <blockquote> Protocol stricthttps = new Protocol( "https", new StrictSSLProtocolSocketFactory(true),
     *                       443);
     *                       <p/>
     ...
     *
     * @return Host name verification flag. Either <code>true</code> if host name verification is turned on, or
     *         <code>false</code> if host name verification is turned off.
     */
     ...
     * @throws java.net.UnknownHostException If we are not able to resolve the SSL sessions returned server host name.
     */
