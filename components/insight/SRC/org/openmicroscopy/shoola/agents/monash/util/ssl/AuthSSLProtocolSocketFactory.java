 ...
 * <p/>
 * <p>
 * AuthSSLProtocolSocketFactory will enable server authentication when supplied with a {@link java.security.KeyStore truststore} file
 ...
 * <p/>
 * <p>
 * AuthSSLProtocolSocketFactory will enable client authentication when supplied with a {@link java.security.KeyStore keystore} file
...
public class AuthSSLProtocolSocketFactory implements SecureProtocolSocketFactory {
     ...
     *
     * @param keystoreUrl        URL of the keystore file. May be <tt>null</tt> if HTTPS client authentication is not to be used.
     * @param keystorePassword   Password to unlock the keystore. IMPORTANT: this implementation assumes that the same password is used
    ...
    private static KeyManager[] createKeyManagers(final KeyStore keystore, final String password) throws KeyStoreException, NoSuchAlgorithmException,
